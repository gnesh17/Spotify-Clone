...
async function getSongs(folder) {
    ...
    let a = await fetch(`https://spotify-by-gnesh.netlify.app/${folder}/`)
...
async function displayAlbums() {
    ...
    let a = await fetch(`https://spotify-by-gnesh.netlify.app/songs/`)
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            ...
            let a = await fetch(`https://spotify-by-gnesh.netlify.app/songs/${folder}/info.json`)
